...
const ProjectCard: React.FC<ProjectCardProps> = ({ project, className, showDetails = false }) => {
  ...
  return (
    <>
      <motion.div
        ...
        className={className}
      >
        <Card className="h-full overflow-hidden hover:shadow-medium transition-all duration-300 group cursor-pointer"
