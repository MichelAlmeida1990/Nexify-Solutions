...
const contactInfo = [
  ...
  },
  {
    ...
    title: 'Email',
    value: 'contato@michelalmeida.dev',
    href: 'mailto:contato@michelalmeida.dev'
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  {submitSuccess && (
                    ...
                    >
                      <p className="text-green-800 text-sm">
                        ✅ {submitSuccess ? 'Mensagem enviada com sucesso! Entrarei em contato em breve.' : ''}
                      </p>
                    </motion.div>
                  )}
          ...
          >
            ...
            <div className="space-y-6">
              {contactInfo.map((info, index) => (
                <motion.a
                  ...
                  className="flex items-center gap-4 p-4 rounded-lg border border-border/20 hover:border-primary/30 hover:bg-primary/5 transition-all duration-300 group"
                >
            ...
            >
              ...
              <div className="flex gap-4">
                <motion.a
                  href="https://github.com/michelalmeida"
                  target="_blank"
                ...
                <motion.a
                  href="https://linkedin.com/in/michelalmeida"
                  target="_blank"
                  rel="noopener noreferrer"
                  whileHover={{ scale: 1.15, rotate: 3 }}
                  whileTap={{ scale: 0.95, rotate: -3 }}
